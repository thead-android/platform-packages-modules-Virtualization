...
public final class Pvmfw {
    ...
    private static final int PVMFW_ENTRY_RESERVED_MEM = 4;
    ...
    private Pvmfw(
        ...
        if (PVMFW_ENTRY_RESERVED_MEM < mEntryCnt) {
            mEntries[PVMFW_ENTRY_RESERVED_MEM] = Objects.requireNonNull(reservedMemFile);
        }
    ...
    public static final class Builder {
        ...
        @Nullable private File mReservedMemFile;
        ...
        @NonNull
        public Builder setReservedMem(@Nullable File reservedMemFile) {
            mReservedMemFile = reservedMemFile;
            return this;
        }
