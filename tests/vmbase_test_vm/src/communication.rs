...
//! Supports for the communication between vmbase_test_vm and host.

// TODO(ioffe): consolidate this and guest/service_vm/src/communication.src into a single library.
...
use vmbase_test_vm_messages::{Request, Response};
